...
public final class MigaLibEvents
{
        ...
        public static final Event<Void> SERVER_TICK_START = new Event<>(MigaLib.id("server_tick_start"));
        
        
        public static final Event<Void> SERVER_TICK_END = new Event<>(MigaLib.id("server_tick_end"));
        ...
        static void init ()
        {
                ServerTickEvents.START_SERVER_TICK.register(server -> MigaLibSessions.emit(SERVER_TICK_START, null));
                ServerTickEvents.END_SERVER_TICK.register(server -> MigaLibSessions.emit(SERVER_TICK_END, null));
        }
